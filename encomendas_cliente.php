                ...
                <div class="row align-items-center">
                  <div class="col-12">
                    ...
                    <form method="GET" action="registar.php">
                      <input type="hidden" name="action" value="EfectuarEncomenda">
                      <div class="row">
                        <div class="col-6">
                          <div class="mb-4">
                ...
                <div class="container" data-aos="zoom-out" data-aos-delay="100">
                  <div class="row align-items-center">
                    <div class="col-12">
                      ...
                      <th scope='col'>Morada de Entrega</th>
                      ...
                      while($row = mysqli_fetch_array($retval)){
                        ...
                        if ($_SESSION['id_utilizador'] == $id_utilizador) {
                          ...
                          if ($estado != "Agendada") {
                            echo "<td> <a href='editar_encomenda.php?id_encomenda=".$id_encomenda."&action=1'><button type='button' class='btn btn-warning'>Editar</button></a> </td>";
                          }else{
                            echo "<td></td>";
                          }
                          
                          if ($estado == "pendente" || $estado == "validada") {
                            echo "<td> <a href='remover.php?id_encomenda=".$id_encomenda."&action=desmarcarEncomenda'><button type='button' class='btn btn-danger'>Desmarcar</button></a> </td>";
                          }else{
                            echo "<td></td>";
                          }
                          if ($estado == "Desmarcada") {
                            echo "<td> <a href='editar.php?id_encomenda=".$id_encomenda."&action=RemarcarEncomenda'><button type='button' class='btn btn-info'>Remarcar</button></a> </td>";
                          }else{
                            echo "<td></td>";
                          }
                          echo " </tr> ";
