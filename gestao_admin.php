									...
									<div class="row align-items-center">
										<div class="col-12">
											...
											while($row = mysqli_fetch_array($retval)){
												...
												<td>$morada</td>
												<td>$contacto</td>
												<td> <a href='editar_encomenda.php?id_encomenda=".$id_encomenda."&action=2'><button type='button' class='btn btn-warning'>Editar</button></a> </td>
												<td> <a href='remover.php?id_encomenda=".$id_encomenda."&action=removerEncomendaAdmin'><button type='button' class='btn btn-danger'>Apagar</button></a> </td>";

												if ($estado == "pendente") {
													echo "<td> <a href='validar.php?id_encomenda=".$id_encomenda."&action=2'><button type='button' class='btn btn-info'>Validar</button></a> </td>";
												}else{
													echo "<td></td>";
												}
												echo " </tr> ";
									...
									<div class="col-12">
										...
										while($row = mysqli_fetch_array($retval)){
											...
											if ($id_utilizador != $_SESSION['id_utilizador']) {
												echo "<td> <a href='remover.php?id_utilizador=".$id_utilizador."&action=removerUtilizadorAdministrador'><button type='button' class='btn btn-danger'>Apagar</button></a> </td>";
											}else{
												echo "<td></td>";
											}

											if ($tipo_utilizador_numero == 3) {
												echo "<td> <a href='validar.php?id_utilizador=".$id_utilizador."&action=1'><button type='button' class='btn btn-info'>Validar</button></a> </td>";
											}else{
												echo "<td></td>";
											}
											echo " </tr> ";
