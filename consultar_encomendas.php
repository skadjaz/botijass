...
<head>
	...
	<title>Encomendas - <?php echo $_SESSION['tipo_utilizador' ?></title>
										...
										<div class="col-12">
											...
											while($row = mysqli_fetch_array($retval)){
												...
												if ($estado == "validada") {
													...
													<td> <a href='atender.php?id_encomenda=".$id_encomenda."'><button type='button' class='btn btn-success'>Atender</button></a> </td>
													</tr>";
												}
											}
											echo "</tbody></table>";
									...
									<div class="row align-items-center">
										<div class="col-12">
											...
											while($row = mysqli_fetch_array($retval)){
												...
												if ($distribuidor == $_SESSION['id_utilizador'] && $estado == "Agendada") {
													echo "
													<tr>
													<th scope='row'>".$id_encomenda."</th>
													<td>$data_encomenda</td>
