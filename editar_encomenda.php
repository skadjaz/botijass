		...
		<section id="counts" class="counts">
            ...
            if ($action == 1) {
            	echo ('<form method="GET" action="editar.php">
            		...
            		<div class="col-6">
            		<div class="mb-4">
            		<input type="date" placeholder="Utilizador" class="form-control" id="Utilizador" name="data_encomenda" value="'.$data_encomenda.'" required >
            		</div>
            		</div>
            		<div class="col-6">
            		<div class="mb-4">
            		<input type="time" placeholder="Password" class="form-control" id="Utilizador" name="hora_encomenda" value="'.$hora_encomenda.'" required >
            		</div>
            		</div>
            		...
            		<div class="col-6">
            		<div class="mb-4">
            		<select name="produto" class="form-control" value="'.$produto.'" required>
            		...
            		<div class="col-6">
            		<div class="mb-4">
            		<input type="number" placeholder="Quantidade" class="form-control" name="quantidade" value="'.$quantidade.'" required>
            		</div>
            		</div>
            		<div class="w-100"></div>
            		<div class="col-12">
            		<!-- Cena das Moradas -->
            		<div class="mb-4">
            		<input type="text" placeholder="Introduza Morada de Entrega" class="form-control" id="Utilizador" name="morada_entrega" value="'.$morada_entrega.'">
